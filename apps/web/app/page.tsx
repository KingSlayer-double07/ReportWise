  ...
  const plans = [
    {
      ...
      features: ["Up to 200 students", "All report sheet types", "Score entry dashboard", "PDF generation", "Email support"],
      cta: "Get Started",
      highlight: false,
    },
    {
      ...
      features: ["200–1000 students", "Everything in Starter", "Multi-class management", "Promotion automation", "Priority support", "Custom branding"],
